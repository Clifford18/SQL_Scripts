  ...
  USE `employee_management_system`;
    ...
    UNIQUE KEY `uindex_tasks_task_id_employee_id`(`task_id`,`employee_id`),
    
    KEY `fk_employees_tasks__employee_id` (`employee_id`),
    CONSTRAINT `fk_employees_tasks__employee_id` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`employee_id`) ON UPDATE CASCADE ON DELETE RESTRICT 
    ) ;
